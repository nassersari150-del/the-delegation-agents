      ...
      >
        ...
        <div className="max-w-md mx-auto">
          <div className="mb-6">
            ...
            >
              <span className="text-[10px] font-black uppercase tracking-wider text-emerald-600">Obtenir une clé OpenRouter gratuite</span>
            ...
            <p className="text-zinc-400 text-sm font-medium leading-relaxed max-w-[240px]">
              Ta clé est stockée localement et ne quitte jamais ton navigateur.
            </p>
          </div>
            ...
            return (
              <div className="mb-6 p-3 bg-red-50 border border-red-100 rounded-2xl flex items-start gap-2 animate-in fade-in slide-in-from-top-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-black uppercase tracking-wider text-red-500 mb-0.5">Erreur API</p>
                  <div className={`${isErrorExpanded ? 'max-h-48' : 'max-h-24'} overflow-y-auto pr-1`}>
                    ...
                    {isLongError && (
                      ...
                      >
                        {isErrorExpanded ? 'Voir moins' : 'Voir plus'}
                      </button>
                    )}
                  </div>
                </div>
          ...
          <div className="mb-10">
            ...
            <div className="relative group">
              <input
                ...
                placeholder="Colle ta clé OpenRouter ici"
